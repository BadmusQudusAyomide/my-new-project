! function(e) {
    ...
    100: function(e, t, r) {
        ...
        function g(e, t, r) {
            ...
            }(t, "string"), (t = "symbol" == v(n) ? n : String(n)) in e ? Object.defineProperty(e, t, {
                value: r,
                enumerable: !0,
                configurable: !0,
                writable: !0
        ...
        window.isEditMode = !1, window.ea = {
            ...
            elementStatusCheck: function(e) {
                return !(!window.eaElementList || !(e in window.eaElementList)) || (window.eaElementList = m(m({}, window.eaElementList), {}, g({}, e, !0)), !1)
            }
        ...
        ea.hooks.addAction("ea-advanced-tabs-triggered", "ea", w), ea.hooks.addAction("ea-advanced-accordion-triggered", "ea", w), jQuery(window).on("elementor/frontend/init", (function() {
            ...
            })), b = jQuery, ea.getToken = function() {
                localize.nonce && !ea.noncegenerated && b.ajax({
                ...
                var t, r = b(this).attr("href");
                (t = (r = void 0 === r ? "" : r).startsWith("#")) || (t = (r = r.replace(localize.page_permalink, "")).startsWith("#"));
                try {
                    if (t && (b(r).hasClass("eael-tab-item-trigger") || b(r).hasClass("eael-accordion-header")) && (b(r).trigger("click"), void 0 !== r && r)) {
                        var n = b(r).closest(".eael-advance-tabs").data("custom-id-offset");
                        n = n ? parseFloat(n) : 0, b("html, body").animate({
                            scrollTop: b(r).offset().top - n
                        }, 300)
                    }
                } catch (e) {}
            })),
            function(e) {
                e(document).on("click", ".theme-savoy .eael-product-popup .nm-qty-minus, .theme-savoy .eael-product-popup .nm-qty-plus", (function(t) {
                    var r = e(this),
                        n = r.closest(".quantity").find(".qty"),
                        o = parseFloat(n.val()),
                        i = parseFloat(n.attr("max")),
                        a = parseFloat(n.attr("min")),
                        s = n.attr("step");
                    o && "" !== o && "NaN" !== o || (o = 0), "" !== i && "NaN" !== i || (i = ""), "" !== a && "NaN" !== a || (a = 0), "any" !== s && "" !== s && void 0 !== s && "NaN" !== parseFloat(s) || (s = 1), r.hasClass("nm-qty-plus") ? i && (i == o || o > i) ? n.val(i) : n.val(o + parseFloat(s)) : a && (a == o || o < a) ? n.val(a) : o > 0 && n.val(o - parseFloat(s))
                }))
            }(jQuery),
            function(e) {
