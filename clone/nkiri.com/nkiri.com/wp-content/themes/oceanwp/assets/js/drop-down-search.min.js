! function o(n, s, l) {
    ...
    for (var a = "function" == typeof require && require, e = 0; e < l.length; e++) u(l[e]);
    return u
}({
    1: [function(e, t, r) {
        "use strict";
    ...
    2: [function(e, t, r) {
        ...
        r.default = function e() {
            (0, n.default)(this, e), (0, s.default)(this, "focus", function(e, t) {
    ...
    3: [function(e, t, r) {
        ...
        function c(r) {
            ...
            return function() {
                ...
                return t = o ? (e = (0, a.default)(this).constructor, Reflect.construct(t, arguments, e)) : t.apply(this, arguments), (0, u.default)(this, t)
            }
        }
        var d = new WeakMap,
            b = new WeakMap,
            ...
            e = function(e) {
                ...
                function o() {
                    var r;
                    return (0, n.default)(this, o), r = t.call(this), d.set((0, s.default)(r), {
                        writable: !0,
                        value: void 0
                    }), b.set((0, s.default)(r), {
                        writable: !0,
                        ...
                        value: function() {
                            var e;
                            null !== (e = (0, p.default)((0, s.default)(r), d).toggleSearchBtn) && void 0 !== e && e.addEventListener("click", (0, p.default)((0, s.default)(r), h)), document.addEventListener("click", (0, p.default)((0, s.default)(r), y))
                        }
                    }), h.set((0, s.default)(r), {
                        writable: !0,
                        value: function(e) {
                            ...
                            var t = (0, p.default)((0, s.default)(r), d),
                                e = t.toggleSearchBtn,
                                t = t.form;
                            e.parentNode.classList.toggle("active"), t.classList.toggle("show"), r.focus(t, "input.field")
                        }
                    }), y.set((0, s.default)(r), {
                        writable: !0,
                        value: function(e) {
                            e.target.closest("#searchform-dropdown.show") || (null !== (e = (0, p.default)((0, s.default)(r), d).form) && void 0 !== e && e.classList.remove("show"), null === (e = (0, p.default)((0, s.default)(r), d).toggleSearchBtn) || void 0 === e || null !== (e = e.parentNode) && void 0 !== e && e.classList.remove("active"))
                        }
                    }), "drop_down" !== f.options.menuSearchStyle ? (0, u.default)(r) : ((0, p.default)((0, s.default)(r), b).call((0, s.default)(r)), (0, p.default)((0, s.default)(r), x).call((0, s.default)(r)), r)
                }
                return o
            }(e.default);
        window.oceanwp = window.oceanwp || {}, oceanwp.dropDownSearch = new e
    }, {
        "../../constants": 1,
        "./base": 2,
    ...
    16: [function(e, r, t) {
        function o(e, t) {
            ...
            }, r.exports.default = r.exports, r.exports.__esModule = !0, o(e, t)
        }
