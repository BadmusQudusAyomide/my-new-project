        ...
        3651: (e, t, n) => {
            ...
            class BaseFilterFrontendModule extends elementorModules.Module {
                ...
                removeFilterFromLoopWidget(e, t) {
                    this.loopWidgetsStore[e] || this.addWidgetToLoopWidgetsStore(e), delete this.loopWidgetsStore[e].filters[t], this.refreshLoopWidget(e, t)
                }
                setFilterDataForLoopWidget(e, t, n) {
                    let s = !(arguments.length > 3 && void 0 !== arguments[3]) || arguments[3];
                    this.loopWidgetsStore[e] || this.addWidgetToLoopWidgetsStore(e), this.loopWidgetsStore[e].filters[t] = n, s ? this.refreshLoopWidget(e, t) : this.consolidateFiltersForLoopWidget(e)
                }
                consolidateFiltersForLoopWidget(e) {
                    ...
                    for (const e in t) {
                        const s = t[e],
                            o = s.filterType,
                            r = s.filterData;
                        n[o] || (n[o] = {}), n[o][r.selectedTaxonomy] || (n[o][r.selectedTaxonomy] = []), n[o][r.selectedTaxonomy].includes(r.term) || n[o][r.selectedTaxonomy].push(r.term)
                    }
                ...
                updateURLQueryString(e) {
                    const t = new URL(window.location.href).searchParams,
                        ...
                        o = this.getFilterHelperAttributes(e);
                    t.forEach(((e, t) => {
                        t.startsWith("e-filter") || s.append(t, e)
                    }));
                    for (const e in n) s.set(e, n[e]);
                    let r = s.toString();
                    r = o.pageNum > 1 ? r ? this.formatQueryString(o.baseUrl, r) : o.baseUrl : r ? `?${r}` : location.pathname, history.pushState(null, null, r)
                }
