...
! function() {
    var e = {
            2: function(e, t, n) {
                n = "undefined" != typeof window ? window : void 0 !== n.g ? n.g : "undefined" != typeof self ? self : {}, e.exports = n
            },
            1: function(e) {
            ...
            8: function(e, t, n) {
                ...
                var c, u, p = i.window.navigator,
                    m = -1 < p.userAgent.indexOf("MSIE ") || -1 < p.userAgent.indexOf("Trident/") || -1 < p.userAgent.indexOf("Edge/"),
                ...
                function g() {
                    u = d ? (!c && document.body && ((c = document.createElement("div")).style.cssText = "position: fixed; top: -9999px; left: 0; height: 100vh; width: 0;", document.body.appendChild(c)), (c ? c.clientHeight : 0) || i.window.innerHeight || document.documentElement.clientHeight) : i.window.innerHeight || document.documentElement.clientHeight
                }
                g(), i.window.addEventListener("resize", g), i.window.addEventListener("orientationchange", g), i.window.addEventListener("load", g), o()((function() {
                    g()
                }));
                var y = [];
                ...
                function h() {
                    y.length && (y.forEach((function(e, t) {
                        var n, o = e.instance,
                            a = e.oldData;
                        e = {
                            width: (n = o.$item.getBoundingClientRect()).width,
                            height: n.height,
                            top: n.top,
                            bottom: n.bottom,
                            wndW: i.window.innerWidth,
                            wndH: u
                        }, a = (n = !a || a.wndW !== e.wndW || a.wndH !== e.wndH || a.width !== e.width || a.height !== e.height) || !a || a.top !== e.top || a.bottom !== e.bottom;
                        y[t].oldData = e, n && o.onResize(), a && o.onScroll()
                    })), i.window.requestAnimationFrame(h))
                }
                var b = 0,
                    v = function() {
                        function e(t, n) {
                            ...
                            var o = this;
                            o.instanceID = b, b += 1, o.$item = t, o.defaults = {
                                type: "scroll",
                                speed: .5,
                                imgSrc: null,
                            ...
                            var i, r, s = o.$item.dataset || {},
                                c = {};
                            Object.keys(s).forEach((function(e) {
                                var t = e.substr(0, 1).toLowerCase() + e.substr(1);
                                t && void 0 !== o.defaults[t] && (c[t] = s[e])
                            })), o.options = o.extend({}, o.defaults, c, n), o.pureOptions = o.extend({}, o.options), Object.keys(o.options).forEach((function(e) {
                                "true" === o.options[e] ? o.options[e] = !0 : "false" === o.options[e] && (o.options[e] = !1)
                            })), o.options.speed = Math.min(2, Math.max(-1, parseFloat(o.options.speed))), "string" == typeof o.options.disableParallax && (o.options.disableParallax = new RegExp(o.options.disableParallax)), o.options.disableParallax instanceof RegExp && (i = o.options.disableParallax, o.options.disableParallax = function() {
                                return i.test(p.userAgent)
                            }), "function" != typeof o.options.disableParallax && (o.options.disableParallax = function() {
                                return !1
                            }), "string" == typeof o.options.disableVideo && (o.options.disableVideo = new RegExp(o.options.disableVideo)), o.options.disableVideo instanceof RegExp && (r = o.options.disableVideo, o.options.disableVideo = function() {
                                return r.test(p.userAgent)
                            }), "function" != typeof o.options.disableVideo && (o.options.disableVideo = function() {
                                return !1
                            }), (n = (n = o.options.elementInViewport) && "object" === l(n) && void 0 !== n.length ? a(n, 1)[0] : n) instanceof Element || (n = null), o.options.elementInViewport = n, o.image = {
                        ...
                        return t = e, (n = [{
                            key: "css",
                            value: function(e, t) {
                                return "string" == typeof t ? i.window.getComputedStyle(e).getPropertyValue(t) : (t.transform && f && (t[f] = t.transform), Object.keys(t).forEach((function(n) {
                                    e.style[n] = t[n]
                                })), e)
                            }
                        }, {
                            ...
                            value: function() {
                                return {
                                    width: i.window.innerWidth || document.documentElement.clientWidth,
                                    height: u,
                            ...
                            value: function() {
                                ...
                                t.options.keepImg || ((e = t.$item.getAttribute("style")) && t.$item.setAttribute("data-jarallax-original-styles", e), !t.image.useImgTag || (e = t.image.$item.getAttribute("style")) && t.image.$item.setAttribute("data-jarallax-original-styles", e)), "static" === t.css(t.$item, "position") && t.css(t.$item, {
                                    ...
                                    var t = i.window.getComputedStyle(e);
                                    return (e = t["-webkit-transform"] || t["-moz-transform"] || t.transform) && "none" !== e || /(auto|scroll)/.test(t.overflow + t["overflow-y"] + t["overflow-x"])
                            ...
                            value: function() {
                                y.push({
                                    instance: this
                                }), 1 === y.length && i.window.requestAnimationFrame(h)
                            }
                        }, {
                            ...
                            value: function() {
                                ...
                                y.forEach((function(t, n) {
                                    t.instance.instanceID === e.instanceID && y.splice(n, 1)
                                }))
                            }
                        }, {
                            key: "destroy",
                            ...
                            value: function() {
                                var e, t = this,
                                    ...
                                    r = 0,
                                    l = o;
                                return a && (i < 0 ? (r = i * Math.max(o, u), u < o && (r -= i * (o - u))) : r = i * (o + u), 1 < i ? l = Math.abs(r - u) : i < 0 ? l = r / i + Math.abs(r) : l += (u - o) * (1 - i), r /= 2), t.parallaxScrollDistance = r, e = a ? (u - l) / 2 : (o - l) / 2, t.css(t.image.$item, {
                                    height: "".concat(l, "px"),
                                    marginTop: "".concat(e, "px"),
                                    left: "fixed" === t.image.position ? "".concat(n.left, "px") : "0",
                            ...
                            key: "onScroll",
                            value: function(e) {
                                var t, n, o, a, r, l, s, c = this,
                                    p = c.$item.getBoundingClientRect(),
                                    m = p.top,
                                    d = p.height,
                                    f = {},
                                    g = p;
                ...
                o = function(e, t) {
                    for (var n, o = (e = ("object" === ("undefined" == typeof HTMLElement ? "undefined" : l(HTMLElement)) ? e instanceof HTMLElement : e && "object" === l(e) && null !== e && 1 === e.nodeType && "string" == typeof e.nodeName) ? [e] : e).length, i = 0, a = arguments.length, r = new Array(2 < a ? a - 2 : 0), s = 2; s < a; s++) r[s - 2] = arguments[s];
                    for (; i < o; i += 1)
                        if ("object" === l(t) || void 0 === t ? e[i].jarallax || (e[i].jarallax = new v(e[i], t)) : e[i].jarallax && (n = e[i].jarallax[t].apply(e[i].jarallax, r)), void 0 !== n) return n;
                    return e
                };
    ...
    ! function() {
        ...
        var l, s = i.window.jarallax;
        i.window.jarallax = a["default"], i.window.jarallax.noConflict = function() {
            return i.window.jarallax = s, this
        }, void 0 !== i.jQuery && ((e = function() {
            for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++) t[n] = arguments[n];
            Array.prototype.unshift.call(t, this);
            var o = a["default"].apply(i.window, t);
            return "object" !== r(o) ? o : this
        }).constructor = a["default"].constructor, l = i.jQuery.fn.jarallax, i.jQuery.fn.jarallax = e, i.jQuery.fn.jarallax.noConflict = function() {
            return i.jQuery.fn.jarallax = l, this
        }), t()((function() {
