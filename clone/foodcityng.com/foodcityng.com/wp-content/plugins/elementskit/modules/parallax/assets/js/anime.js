! function(n, e) {
    ...
    function s(n, e) {
        ...
        function v(n) {
            var t = e ? e * n / 1e3 : n;
            return t = d < 1 ? Math.exp(-t * d * l) * (1 * Math.cos(p * t) + h * Math.sin(p * t)) : (1 + h * t) * Math.exp(-t * l), 0 === n || 1 === n ? n : 1 - t
        }
        return e ? v : function() {
            var e = r.springs[n];
            if (e) return e;
    ...
    var l, d, p = function() {
            ...
            return function(e, t, r, u) {
                if (0 <= e && e <= 1 && 0 <= r && r <= 1) {
                    ...
                    if (e !== t || r !== u)
                        for (var c = 0; c < 11; ++c) i[c] = a(c * n, e, r);
                    return function(n) {
                ...
                function s(t) {
                    for (var u = 0, c = 1; 10 !== c && i[c] <= t; ++c) u += n;
                    ...
                    return f >= .001 ? function(n, e, t, r) {
                        ...
                        for (var u, i, c = 0;
                            (u = a(i = e + (t - e) / 2, r, o) - n) > 0 ? t = i : e = i, Math.abs(u) > 1e-7 && ++c < 10;);
                        return i
                    }(t, u, u + n, e, r)
                }
            }
    ...
    function I(n, e, t) {
        if (M([t, "deg", "rad", "turn"], O(e))) return e;
        var a = r.CSS[e + t];
        if (!i.und(a)) return a;
            ...
            case "transform":
                return function(n, e, t, r) {
                    var a, u = o(e, "scale") ? 1 : 0 + (o(a = e, "translate") || "perspective" === a ? "px" : o(a, "rotate") || o(a, "skew") ? "deg" : void 0),
                        i = T(n).get(e) || u;
                    return t && (t.transforms.list.set(e, i), t.transforms.last = e), r ? I(n, i, r) : i
                }(n, e, r, t);
            case "css":
                return D(n, e, t);
            case "attribute":
    ...
    function L(n) {
        ...
        switch (n.tagName.toLowerCase()) {
            ...
            case "polyline":
                return S(n);
            case "polygon":
                return t = (e = n).points, S(e) + N(t.getItem(t.numberOfItems - 1), t.getItem(0))
        }
        var e, t, r, a, o
    }
                        ...
                        var r = function(n, e) {
                                ...
                                return n.tweens.map((function(r) {
                                    var a = function(n, e) {
                                        ...
                                        d = O(l) || O(s),
                                        p = c || d;
                                    return i.und(u) && (u = f), a.from = H(l, p), a.to = H(F(u, l), p), a.start = t ? t.end : 0, a.end = a.start + a.delay + a.duration + a.endDelay, a.easing = v(a.easing, a.duration), a.isPath = i.pth(o), a.isPathTargetInsideSVG = a.isPath && i.svg(e.target), a.isColor = i.col(a.from.original), a.isColor && (a.round = 1), t = a, a
                                }))
                            }(e, n),
                            a = r[r.length - 1];
                        return {
        ...
        R = function() {
            ...
            function e(t) {
                for (var r = _.length, a = 0; a < r;) {
                    var o = _[a];
                    o.paused ? (_.splice(a, 1), r--) : (o.tick(t), a++)
                }
    ...
    function K(t) {
        ...
        var l, d, p, h, v, g, y, b, M = (d = w(n, l = t), h = X(p = w(e, l), l), y = Q(g = G(v = $(l.targets), h), p), b = z, z++, k(d, {
            id: b,
            children: [],
            animatables: v,
            animations: g,
        ...
        function C() {
            o = 0, u = O(M.currentTime) * (1 / K.speed)
        }
        ...
        function I(n) {
            for (var e = 0, t = M.animations, r = t.length; e < r;) {
                ...
                for (var f = a(n - s.start - s.delay, 0, s.duration) / s.duration, l = isNaN(f) ? 1 : s.easing(f), d = s.to.strings, p = s.round, h = [], v = s.to.numbers.length, g = void 0, y = 0; y < v; y++) {
                    ...
                    b = s.isPath ? q(s.value, l * x, s.isPathTargetInsideSVG) : w + l * (x - w), p && (s.isColor && y > 2 || (b = Math.round(b * p) / p)), h.push(b)
                }
                var k = d.length;
                if (k) {
                    g = d[0];
                ...
                Y[o.type](u.target, o.property, g, u.transforms), o.currentValue = g, e++
            }
        }
        ...
        return f(M), M.reset = function() {
            ...
            i = n, o || (o = i), B((i + (u - o)) * K.speed)
        }, M.seek = function(n) {
            B(O(n))
        }, M.pause = function() {
            M.paused = !0, C()
        }, M.play = function() {
            M.paused && (M.completed && M.reset(), M.paused = !1, _.push(M), C(), R())
        }, M.reverse = function() {
    ...
    function nn(n, e) {
        ...
        for (var a = r.length; a--;) {
            var o = r[a],
                u = o.animations;
            U(n, u), u.length || o.children.length || r.splice(a, 1)
        }
        t.length || r.length || e.pause()
    }
    return K.version = "3.2.1", K.speed = 1, K.suspendWhenDocumentHidden = !0, K.running = _, K.remove = function(n) {
        for (var e = V(n), t = _.length; t--;) nn(e, _[t])
    }, K.get = E, K.set = Z, K.convertPx = I, K.path = function(n, e) {
        ...
        return t.duration = 0, t.add = function(r, a) {
            ...
            var l = t.duration;
            f.autoplay = !1, f.direction = t.direction, f.timelineOffset = i.und(a) ? l : F(a, l), c(t), t.seek(f.timelineOffset);
            var d = K(f);
            c(d), u.push(d);
            var p = Q(u, n);
            return t.delay = p.delay, t.endDelay = p.endDelay, t.duration = p.duration, t.seek(0), t.reset(), t.autoplay && t.play(), t
        }, t
    }, K.easing = v, K.penner = h, K.random = function(n, e) {
