                        ...
                        n = o.extend({
                            ...
                            activate: function() {
                                var i = this.getElementSettings(),
                                    ...
                                    n = {
                                        to: i.ekit_sticky,
                                        offset: i.ekit_sticky_offset.size,
                                        effectsOffset: i.ekit_sticky_effect_offset.size,
                                        classes: {
                                            sticky: "ekit-sticky",
                ...
                t = jQuery, e = function(e, i) {
                    var o, n, s = !1,
                        ...
                        g = function() {
                            ...
                            if (s) {
                                var u = m(a.$spacer);
                                t = "top" === n.to ? u.top.fromTop - e : -u.bottom.fromBottom - e, n.parent && _(), t > 0 && v()
                            } else {
                                var k = m(o);
                                (t = "top" === n.to ? k.top.fromTop - e : -k.bottom.fromBottom - e) <= 0 && (h(), n.parent && _())
