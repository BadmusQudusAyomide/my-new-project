function UET(o) {
    ...
    this.loadConfig = function() {
        ...
        for (this.beaconParams.mid = this.getUuidV4(!0), t = undefined, a = 0; a < 5; a++)
            if (t = "ueto_" + this.makeRandomStr(10), !window[t]) break;
        this.stringExists(o.ti) && (b = ["56004448", "5798164", "20132024", "4000835", "4074038"], v = window.navigator.userLanguage || window.navigator.language, this.stringExists(v) && v.indexOf("de") === 0 && b.indexOf(o.ti) !== -1 && (this.uetConfig.deBlock = !0, this.uetConfig.cookieAllowed = !1));
        try {
            this.stringExists(t) && !window[t] ? window[t] = this.uetInstance : t = undefined
        } catch (n) {}
        this.stringExists(o.ti) && !this.uetConfig.disableContainer && (n = document.createElement("script"), y = e + "//" + this.domain + "/p/action/" + o.ti + ".js", this.stringExists(this.uetConfig.batDebug) && (y += "?bat_debug=" + this.uetConfig.batDebug), n.src = y, n.type = "text/javascript", n.async = 1, t && n.setAttribute("data-ueto", t), document.head.appendChild(n));
        navigator.userAgentData && navigator.userAgentData.getHighEntropyValues && navigator.userAgentData.platform === "Windows" && (this.deferLoad = !0, r = this, p = setTimeout(function() {
            r.deferLoad = !1;
            r.fireSendBeacon("error", {
        ...
        this.stringExists(this.uetConfig.batDebug) && window.opener && this.stringExists(o.ti) && (w = "https://ui.ads.microsoft.com", document.referrer && window.URL && (h = new URL(document.referrer), h.protocol === "https:" && /\.microsoft\.com$/.test(h.hostname) && (w = h.origin)), window.opener.postMessage({
            type: "AckBatDbgMode",
            tagId: o.ti
        }, w))
    };
    ...
    this.evt = function(n, t, i, r) {
        ...
        if (r = r !== !1, i = i || {}, this.uetConfig.disableAutoPageView === !0 && this.evqDispatch === !1 && this.dispatchq(!1), typeof i == "object") {
            if (this.uetConfig.allRep === !0 ? i.rep = "1" : i.hasOwnProperty("rep") && (i.rep === 1 || i.rep === "1" || i.rep === !0 ? i.rep = "1" : delete i.rep), n === this.pageLoadEvt && (this.uetConfig.gtagPid === !0 && "enhanced_conversion_data" in window && typeof enhanced_conversion_data == "object" && (this.pageLevelParams.pid = {
                ...
                }), r && this.pageLevelParams.hasOwnProperty("pid") && !i.hasOwnProperty("pid") && (i.pid = this.pageLevelParams.pid)), this.pageLevelParams.hasOwnProperty("pid") && (this.knownEvents[t] = this.knownEvents[t] || [], this.knownEvents[t].indexOf("pid") === -1 && this.knownEvents[t].push("pid")), r ? this.validateDataObject(n, i) : (i.event_action = t, n === this.customEvt && i.hasOwnProperty("gtm_tag_source") && (i = this.mapGtmParams(i)), i = this.validateDataObjectNew(n, i)), n === this.customEvt) {
                h = [];
                for (y in i) h.push(y);
