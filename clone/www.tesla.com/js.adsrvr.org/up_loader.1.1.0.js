                ...
                var a, n, d, c = [],
                    u = {
                            ...
                            if (!d) {
                                ...
                                for (a && (o = a, a = 0), e = 0, t = r.length; e < t; e++) "array" === (i = l.type(n = r[e])) ? u.done.apply(u, n) : "function" === i && c.push(n);
...
function TTDUniversalPixelApi(C) {
    this.getVersion = function() {
        ...
        if ("string" == typeof arguments[3] && (arguments[3] = null, 4 < arguments.length))
            for (var i = 4; i < arguments.length; i++) arguments[i - 1] = arguments[i];
        if (e && "" != e && o && !(o.length <= 0)) {
            ...
            if (r) {
                ...
                var g = null,
                    v = !1,
                    y = null,
                    _ = ("function" == typeof __tcfapi ? (b = setTimeout(x, 1e3), __tcfapi("addEventListener", 2, A)) : "function" == typeof __cmp ? (g = setTimeout(D, 1e3), __cmp("ping", null, L)) : "function" == typeof __gpp ? void 0 !== (p = w()).gppString ? I(p.gppString, p.gppSid) : (_ = setTimeout(S, 1e3), __gpp("addEventListener", j)) : T(), null),
                    h = !1,
                    b = null,
                    E = !1
            }
        ...
        function j(e, t) {
            var n;
            h ? __gpp("removeEventListener", function() {}, e.listenerId) : "signalStatus" === e.eventName && "ready" === e.data && (n = w(), clearTimeout(_), y = new Date, I(n.gppString, n.gppSid), __gpp("removeEventListener", function() {}, e.listenerId))
        }
        ...
        function L(e) {
            v || (e.cmpLoaded || e.gdprAppliesGlobally ? (clearTimeout(g), y = new Date, __cmp("getConsentData", null, T)) : setTimeout(function() {
                __cmp("ping", null, L)
            }, 200))
        }

        function T(e) {
            null != y && (a = a + "&ret=" + (new Date - y)), v && (a += "&pto=1"), null != e && (a = a + "&gdpr=" + (e.gdprApplies ? "1" : "0") + "&gdpr_consent=" + e.consentData), R()
        }

        function R() {
            for (var e = "universal_pixel_" + o.join("_"), t = document.getElementById(e); t && t.parentElement.removeChild(t), t = document.getElementById(e););
            var n = document.createElement("iframe");

            function i() {
                r.appendChild(n)
            }
            n.setAttribute("id", e), n.setAttribute("height", 0), n.setAttribute("width", 0), n.setAttribute("style", "display:none;"), n.setAttribute("src", a), n.setAttribute("title", "TTD Universal Pixel"), "complete" === document.readyState ? setTimeout(i, 0) : window.addEventListener ? window.addEventListener("load", i) : window.attachEvent ? window.attachEvent("onload", i) : i()
        }
        ...
        function A(e, t) {
            E ? __tcfapi("removeEventListener", 2, function(e) {}, e.listenerId) : t && (clearTimeout(b), t = e, null != y && (a = a + "&ret=" + (new Date - y)), E && (a += "&pto=1"), null != t && (a = a + "&gdpr=" + function(e) {
                return e ? "1" : "0"
            }(t.gdprApplies) + "&gdpr_consent=" + t.tcString), R(), y = new Date, __tcfapi("removeEventListener", 2, function(e) {}, e.listenerId))
        }

        function I(e, t) {
            null != y && (a = a + "&ret=" + (new Date - y)), null != e && (a = a + "&gpp_consent=" + e), null != t && (a = a + "&gpp_sid=" + t), R()
        }
    }
}